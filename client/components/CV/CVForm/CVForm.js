    ...
    const onFormSubmit = (data) => {
        try {
            ...
            if (err instanceof yup.ValidationError) {
                ...
                console.error("Validation inner:", err.inner);
                // Afficher toutes les erreurs résiduelles dans la console
            ...
            <div className={styles.personalInfoSection}>
                <div className={styles.formGroup}>
                    ...
                    {errors.personalInfo?.firstName &&
                        <p className={styles.error}>{errors.personalInfo.firstName.message}</p>}
                </div>
                ...
                <div className={styles.formGroup}>
                    ...
                    {errors.personalInfo?.lastName &&
                        <p className={styles.error}>{errors.personalInfo.lastName.message}</p>}
                </div>
                ...
                <div className={styles.formGroup}>
                    ...
                    {errors.personalInfo?.profession &&
                        <p className={styles.error}>{errors.personalInfo.profession.message}</p>}
                </div>
        ...
        />
                ...
                <div key={field.id} className={styles.experienceItem}>
                    <div className={styles.formGroup}>
                        ...
                        {errors.experiences?.[index]?.company &&
                            <p className={styles.error}>{errors.experiences[index].company.message}</p>}
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.experiences?.[index]?.position &&
                            <p className={styles.error}>{errors.experiences[index].position.message}</p>}
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.experiences?.[index]?.startDate &&
                            <p className={styles.error}>{errors.experiences[index].startDate.message}</p>}
                    </div>
                ...
                <div key={field.id} className={styles.educationItem}>
                    <div className={styles.formGroup}>
                        ...
                        {errors.educations?.[index]?.institution &&
                            <p className={styles.error}>{errors.educations[index].institution.message}</p>}
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.educations?.[index]?.degree &&
                            <p className={styles.error}>{errors.educations[index].degree.message}</p>}
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {errors.educations?.[index]?.startDate &&
                            <p className={styles.error}>{errors.educations[index].startDate.message}</p>}
                    </div>
            ...
            <div className={styles.submitContainer}>
                ...
                <button
                    ...
                    className={`${styles.cancelBtn} ${styles.cancelBtnMargin}`}
                >
                    Annuler
                </button>
            </div>
